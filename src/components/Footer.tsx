  ...
  return (
    <footer className="footer padding bg-bgGrey font-assistant text-black">
      ...
      <div className="flex flex-wrap">
        {/* Quick Links */}
        <div className="quick-links w-full xl:w-[65%] 2xl:w-[65%] 3xl:w-[65%] flex flex-wrap ">
          {/* Get Started */}
          <div className="get-started pt-5 w-full lg:w-[50%] xl:w-[33.3%] 2xl:w-[33.3%] 3xl:w-[33.3%]">
            ...
            <ul className="text-[18px] leading-[24px] text-black">
              ...
              <li className="mb-1">
                <Link
                  href={"/discount-code-registeration"}
                  className=" hover:text-red duration-300"
                >
                  Sign-up
                </Link>
              ...
              <li className="mb-1">
                <Link
                  href={"https://calendly.com/bittruster/call?month=2023-12"}
                  className=" hover:text-red duration-300"
                >
          ...
          <div className="about-us pt-5 w-full lg:w-[50%] xl:w-[33.3%] 2xl:w-[33.3%] 3xl:w-[33.3%]">
            ...
            <ul className="text-[18px] leading-[24px] text-black">
              ...
              <li className="mb-1">
                <Link href={"/blogs"} className=" hover:text-red duration-300">
                  Blog
                </Link>
              </li>
              <li className="mb-1">
          ...
          <div className="contact-info pt-5 w-full lg:w-[50%] xl:w-[33.3%] 2xl:w-[33.3%] 3xl:w-[33.3%]">
            <div className="mb-[20px] p-2 flex items-center justify-between w-fit bg-white border border-green-600 rounded-sm">
              <Link
              target="_blank"
                href={
                  "https://de.trustpilot.com/review/bittruster.com?utm_medium=trustbox&utm_source=TrustBoxReviewCollector"
                }
              ...
              >
                ...
                <svg
                  role="img"
                  aria-labelledby="trustpilotLogo-qvbl3jetcr"
                  viewBox="0 0 126 31"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-[20px]"
                >
                  <title id="trustpilotLogo-qvbl3jetcr">Trustpilot</title>
                  <path
              ...
              {/* <iframe
                ...
                src="https://widget.trustpilot.com/trustboxes/56278e9abfbbba0bdcd568bc/index.html?templateId=56278e9abfbbba0bdcd568bc&amp;businessunitId=6568647ab401271dada3786a#locale=de-DE&amp;styleHeight=52px&amp;styleWidth=100%25"
                className="overflow-hidden relative h-[52px] w-full border-none block"
              ></iframe> */}
            </div>
            <h4 className="links-heading font-bold text-[24px] leading-[24px] uppercase mb-5">
              Contact Info
            ...
            <ul className="text-[16px] leading-[24px] text-textGrey">
              <li className="mb-1">
                BitTruster GmbH Breuerwiesenstrasse 43 <br /> 65929 Frankfurt
                Germany
              </li>
              <li className="mb-1">
                <Link href={"tel:+4969175370"} className="">
                  Phone:{" "}
                  <span className="text-red text-[20px] leading-[30px]">
                    {" "}
                    +49 69 175 370 – 870
                  </span>
                </Link>
              ...
              <li className="mb-1">
                <Link href={"fax:+4969175370"} className="">
                  Fax:{" "}
                  <span className="text-red text-[20px] leading-[30px]">
                    {" "}
                    +49 69 175 370 – 879
              ...
              <li className="mb-1">
                <Link href={"mailto:info@bittruster.com"} className="">
                  Email:{" "}
                  <span className="text-red text-[20px] leading-[30px]">
                    {" "}
                    info@bittruster.com
        ...
        {/* Contact Form */}
        <div className="contact-form hidden w-[35%] xl:block 2xl:block 3xl:block">
          ...
          Your details will not be shared with any third party. 
                <Link href={"/privacy-policy"} className="text-red text-[20px] leading-[30px] underline">
                  Privacy Policy
                </Link>
              </p>
          </div>
        ...
        <div className="socials w-full pt-5">
          <ul className="text-[16px] leading-[24px] text-black lg:flex xl:flex 2xl:flex 3xl:flex items-center gap-4 mb-4">
            <li className="mb-1 w-fit mr-2">
              <Link
                href={"https://twitter.com/bittruster"}
                className="text-black text-[30px] leading-[45px] font-bold hover:text-red flex items-center gap-2"
              >
            ...
            <li className="mb-1 w-fit mr-2">
              <Link
                href={"https://www.facebook.com/bittruster"}
                className="text-black text-[30px] leading-[45px] font-bold hover:text-red flex items-center gap-2"
              >
            ...
            <li className="mb-1 w-fit mr-2">
              <Link
                href={"https://www.linkedin.com/company/bittruster-gmbh"}
                className="text-black text-[30px] leading-[45px] font-bold hover:text-red flex items-center gap-2"
              >
          ...
          <p className="mb-4 text-textGrey text-[16px] leading-[24px] lg:text-[20px] lg:leading-[30px] xl:text-[20px] xl:leading-[30px] 2xl:text-[20px] 2xl:leading-[30px] 3xl:text-[20px] 3xl:leading-[30px]">
            ...
            <span className="text-red text-[20px] leading-[30px]">
              <Link href={"https://brandsonify.com/"}> Brandsonify.</Link>
            </span>
          </p>
        </div>
      </div>
